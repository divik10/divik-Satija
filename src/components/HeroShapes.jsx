...
export function Shapes() {
  return (
    <div className="row-span-1 row-start-1 mx-auto -mt-2 w-full max-w-[500px] scale-[0.94] md:col-span-1 md:col-start-2 md:mr-[0.25rem] md:mt-0 md:max-w-[660px] md:scale-[1.04] lg:mr-[-1.5rem] lg:max-w-[760px] lg:scale-[1.12] xl:mr-[-2rem] xl:max-w-[820px] xl:scale-[1.16]">
